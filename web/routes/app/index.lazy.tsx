    ...
    return (
        <div>
            ...
            <Flex justify={"end"} p={"4"} pt={"6"} gap='3' width={"100%"}>
                <IconButton onClick={()=>{ refetch(); }} color="gray" variant="soft" size={'3'}><CoreLineRefresh/></IconButton>
                <Button size={'3'}><CoreLineNewFolder /> New Project</Button>
                <TextField.Root
                    placeholder="Search"
                    size={"3"}
                    ...
                    <Table.Root size={"3"} variant="ghost">
                        <Table.Header style={{ position: "sticky", top: 0 }}>
                            <Table.Row>
                                ...
                                <Table.ColumnHeaderCell>Current Viewers</Table.ColumnHeaderCell>
                            </Table.Row>
                        </Table.Header>
